...
$(document).ready(function() {
    ...
    function loadmenu() {
        var content =
            ...
            <a class="nav-link" href="nganhnghe">
                <div class="sb-nav-link-icon"><i class="fas fa-table iconmenu"></i></div>
                Ngành nghề
            </a>
            <a class="nav-link" href="salary">
                <div class="sb-nav-link-icon"><i class="fas fa-money iconmenu"></i></div>
                Mức lương
            </a>
            <a class="nav-link" href="phucloi">
                <div class="sb-nav-link-icon"><i class="fas fa-table iconmenu"></i></div>
                Phúc lợi
            </a>
            <a class="nav-link" href="blog">
                <div class="sb-nav-link-icon"><i class="fa fa-newspaper iconmenu"></i></div>
                Bài viết
            </a>
            <a class="nav-link" href="baidang">
                <div class="sb-nav-link-icon"><i class="fas fa-file iconmenu"></i></div>
                Bài đăng
            </a>
            <a class="nav-link" href="doanhnghiep">
                <div class="sb-nav-link-icon"><i class="fa fa-home iconmenu"></i></div>
                Doanh nghiệp
            </a>
