...
public class BlogApi {
    ...
    @GetMapping("/public/top-blog")
    public ResponseEntity<?> topBlog(){
        List<Blog> result = blogService.topBlog();
        return new ResponseEntity<>(result,HttpStatus.OK);
    }

    @GetMapping("/public/top-2-blog")
    public ResponseEntity<?> top2Blog(){
        List<Blog> result = blogService.top2Blog();
        return new ResponseEntity<>(result,HttpStatus.OK);
    }
